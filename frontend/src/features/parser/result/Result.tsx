...
import { resultDataSelector } from "../../../app/resultData/resultData";
...
export const Result: FC<PaperProps> = ({ sx }) => {
  const { data, isLoading } = useAppSelector(resultDataSelector);
        ...
        <TableBody>
          {data.map((row) => (
            ...
            >
              ...
              <TableCell align="right">{row.fraudScore}</TableCell>
              <TableCell align="right">{row.fakeIp}</TableCell>
